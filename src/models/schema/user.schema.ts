...
export default class User {
  //lưu lên database phải đầy đủ trừ id do monggo sẽ tự tạo
  _id?: ObjectId
  name: string
  email: string
  date_of_birth: Date
  ...
  constructor(user: UserType) {
    //ít nhất phải mô tả đc 2 thứ là email và password, còn mấy cái còn lại ko cần thì nó sẽ là defult
